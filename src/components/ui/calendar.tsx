    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          'h-7 w-7 bg-transparent border-slate-200 p-0 text-slate-500 opacity-70 hover:opacity-100 hover:bg-slate-100'
        ),
        ...
        day_outside:
          'day-outside text-slate-400 opacity-50 aria-selected:bg-indigo-50 aria-selected:text-slate-400 aria-selected:opacity-30',
